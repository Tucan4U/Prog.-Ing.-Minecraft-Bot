// Snimi sve entitete i itemove u state.sensors da nodeovi ne moraju skenirati svaki tick
...
function startWorldSensors(bot, state, options = {}) {
    ...
    return {
        ...
        update() { updateWorldSensors(bot, state) },
    }
}

module.exports = { updateWorldSensors, startWorldSensors }