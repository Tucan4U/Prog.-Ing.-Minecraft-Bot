...
function findBestInventoryItemByNames(bot, names, scoreFn = (item) => item.count) {
  const nameSet = new Set(names || []);
  let bestItem = null;
...
module.exports = { equipBestWeapon, needsFood, numOfBlocks, countItemsByNames, findInventoryItemByNames, findBestInventoryItemByNames, hasAnyItem };
